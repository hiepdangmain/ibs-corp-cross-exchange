...
public class GuaranteePdfService {
    ...
    private String typeGuaranteeValue = "";
    ...
    public OutputGuaranteeDownload execute (UserPrincipal principal, GuaranteeRequest request) throws LogicException {
        if (request.getListOrder() == null) {
            throw new BadRequestException("ERROR.GUARANTEE.REQUEST.INVALID");
        }
        Map<String, Object> params = new HashMap<String, Object>();
        validateStep1(request, principal, params);
    ...
    private void validateStep1(GuaranteeRequest guaranteeRequest, UserPrincipal principal, Map<String, Object> params) throws LogicException {
        details = new HashMap<>();
        for (DetailGuarantee item : guaranteeRequest.getListOrder()) {
            ...
            detailGuarantee.setParam(item.getParams());
            detailGuarantee.setSeqNo(item.getSeqNo());
            detailGuarantee.setValue(item.getValue());
        ...
        if (guaranteeRequest.getDocuments().size() > 0) {
            List<BbGuaranteeDocumentConfig> documentConfigs = bbGuaranteeDocumentConfigRepository.
                    findListDocumentConfig(List.of("0", details.get("typeGuarantee").getValue()));
            for (DocumentGuarantee file : guaranteeRequest.getDocuments()) {
                ...
                if (StringUtil.isNotEmpty(file.getDebtDate())) {
                    ...
                    fileAttachContent += "<b>"+file.getFileName() + "</b><br/><br/>";
                }
            }
        }
        getContentHeader();
        getContentFooter(principal);
    ...
    private void getContentFooter(UserPrincipal principal) {
        contentAll += "<br/><br/> <br/><br/><br/><br/><b>ĐẠI DIỆN ĐƠN VỊ</b>";
        contentAll += "<br/><br/> Tên người đại diện:               " /*+ "<b>" + (principal.getNick() != null ? principal.getNick() : "") + "</b>"*/;
        contentAll += "<br/><br/> Mã người dùng :                   " /*+ "<b>" + (principal.getUsername() != null ? principal.getUsername() : "") + "</b>"*/;
        contentAll += "<br/><br/> Số CMND/Hộ chiếu/CCCD :           " /*+ "<b>" + (principal.getCertCode() != null ? principal.getCertCode() : "") + "</b>"*/;
        contentAll += "<br/><br/> Ngày ký:                          " /*+ "<b>" + DateUtil.formatDate(new Date(), DateUtil.FORMAT_DATE_ddMMyyyyHHmmss) + "</b>"*/ + "<br/><br/><br/>";
    }
    ...
    private void getContentHeader() {
        ...
        contentAll +="<br/><br/><b>Tài liệu đính kèm/<i>Attachment</i>:</b><br/><br/>" ;
