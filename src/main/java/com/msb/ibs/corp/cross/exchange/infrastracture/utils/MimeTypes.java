...
public class MimeTypes {
    ...
    public static final String MIME_APPLICATION_VND_MSPOWERPOINT_2007 = "application/vnd.openxmlformats-officedocument.presentationml.presentation";
    public static final String MIME_APPLICATION_VND_MSPOWERPOINT_SLIDESHOW_2007 = "application/vnd.openxmlformats-officedocument.presentationml.slideshow";
    ...
    static {
        mimeTypeMapping = new HashMap<>(200) {
...

            {
                ...
                put1("pptx", MIME_APPLICATION_VND_MSPOWERPOINT_2007);
                put1("pps", MIME_APPLICATION_VND_MSPOWERPOINT);
                put1("ppsx", MIME_APPLICATION_VND_MSPOWERPOINT_SLIDESHOW_2007);
